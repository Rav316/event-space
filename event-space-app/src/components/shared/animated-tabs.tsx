      ...
      <div className="relative bg-muted rounded-2xl p-1 flex w-full overflow-hidden">
        ...
        {tabs.map((tab, i) => (
          <button
            ...
            className={cn(
              'relative z-10 px-5 py-1.5 text-sm font-medium rounded-2xl transition-colors duration-200 flex-1 flex items-center justify-center gap-2 max-[400px]:text-xs',
              i === activeIndex
                ? 'text-foreground'
