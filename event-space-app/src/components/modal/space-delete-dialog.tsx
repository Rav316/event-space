...
import { useSpaceDeleteImpact, useDeleteSpace } from '@/api/spaces/hooks.ts';
...
export const SpaceDeleteDialog = ({ id, name }: Props) => {
  const [open, setOpen] = useState(false);

  const { data: impact, isFetching, refetch } = useSpaceDeleteImpact(id);
